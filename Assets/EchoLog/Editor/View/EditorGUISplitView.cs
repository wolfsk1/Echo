...
namespace com.tdb.echo
{
    public class EditorGUISplitView
    {
        ...
        public EditorGUISplitView(Direction splitDirection, UnityAction needRepaint)
        {
            _needRepaint = needRepaint;
        ...
        {
            if (_splitDirection == Direction.Horizontal)
                _resizeHandlerRect = new Rect(_availableRect.width * _splitNormalizedPosition, _availableRect.y, 5f,
                    _availableRect.height);
            else
                _resizeHandlerRect = new Rect(_availableRect.x, _availableRect.height * _splitNormalizedPosition,
                    _availableRect.width, 5f);
        ...
        private UnityAction _needRepaint;
    }
}